  ...
  return (
    ...
    "
      >
        ...
        <p className="text-red-500 text-8xl">{results.firstName}</p>
      ...
      "
        ...
        {show && (
          <div
            className="bg-gradient-to-r from-[#1a0f14] via-[#2a141c] to-[#1a0f14] rounded-xl 
    shadow-lg w-[260px] absolute top-16 right-47 overflow-hidden border border-gray-700"
          >
    ...
    `}
        ...
        ${index === 0 ? "border-yellow-300" : "border-gray-500"}
      `}
                >
                  <img
                    alt="User photo"
